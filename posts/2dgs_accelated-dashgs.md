---
title: DashGaussian概述
date: 2025-11-24
excerpt: 把 3DGS 优化看成“逐步拟合训练视图中越来越高频成分”的过程，通过 **频域引导的分辨率调度** + **分辨率引导的 primitive 数量调度**，在不同阶段动态控制优化复杂度，从而在几乎不降画质的情况下，大幅加速训练。
tags: ['复杂度','分辨率','优化', '算法', '研发']
readTime: 20min
---
